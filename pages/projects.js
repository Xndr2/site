    ...
    <>
      ...
      <div className='center_container'>
        <div class="pic-ctn">
          ...
          {/* Project 2 */}
          <div className="pic_project">
            <Image src="/images/projects/DiscordBot.png" alt="Discord Bot" className='project_img' height={700} width={1200} />
            <h1>Discord Bot</h1>
          ...
          {/* Project 3 */}
          <div className="pic_project">
            <Image src="/images/projects/FinalProject.jpg" alt="Final School Project" className='project_img' height={700} width={1200} />
          ...
          {/* Project 4 */}
          <div className="pic_project">
            <Image src="/images/projects/Abandoned_Launcher.png" alt="Abandoned Launcher" className='project_img' height={700} width={1200} />
            <h1>Game Launcher</h1>
          ...
          {/* Project 5 */}
          <div className="pic_project">
            <Image src="/images/projects/coding.png" alt="Secret" className='project_img' height={700} width={1200} />
