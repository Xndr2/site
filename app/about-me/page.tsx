...
export const metadata: Metadata = {
  title: 'About',
  description:
    'Learn about Xander - a self-taught developer from Belgium specializing in game development and web applications.',
};
      ...
      <main className="max-w-screen-md mx-auto px-6 pt-28 md:pt-36 pb-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-slate-500 leading-relaxed">
            I started coding by messing around with scripts in games.
            Eventually, I got more into it and started making my own stuff. Now
        ...
        <section>
              ...
              <div key={category.category}>
                ...
                <div className="flex flex-wrap gap-2">
                  {category.items.map(tech => {
                    ...
                    const bgOpacity =
                      level >= 4
                        ? 'bg-cat-sky/20 text-cat-sky border-cat-sky/30'
                        : level >= 3
                    ...
                    return (
                      ...
                      >
                        ...
                        <span>{tech.name}</span>
                        {/* Mobile: show inline */}
                        <span className="text-xs opacity-60 md:hidden">
                          ({tech.level})
                        </span>
          ...
          <p className="text-xs text-slate-400 mt-6">
            Hover over skills to see proficiency level. Highlighted skills
